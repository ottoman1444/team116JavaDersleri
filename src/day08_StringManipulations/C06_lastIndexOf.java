...
public class C06_lastIndexOf {
    public static void main(String[] args) {
        String str = "Java cok fayfali ";
        System.out.println(str.lastIndexOf("a")); //13
        //index sırası aynı kalıyor ama sondan başlayarak kontrol ediyor.

        System.out.println(str.lastIndexOf("a", 10)); //10 10dan itibaren sol tarafı arat.
